...
It seems that the tinyllama does not learn anymore and the learning rate is even decreasing. At checkpoint-1300 I am increasing the learning rate to 4.0E-4 (used to pretrain the model)
